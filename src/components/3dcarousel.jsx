...
const text = [
  "Abhijit - CEO MD Chairman Berger Paints",
  "Akur Rahman - CTO at Hitachi Technologies",
  "Amit Kumar Agarwal - Founder and CEO of Nobroker",
  "Alakh Pandey - Founder & CEO PhysicsWallah",
  "Kanav Hasija- Co-Founder InnovAccer",
  "Pulkit Jain - Co-founder Vedantu",
  "Sean Sohn - CEO of Krafton India (PUBG India)",
  "Suresh Prabhu - Former Minister of Railways of India",
...
>
  ...
  >
    {cards.map((imgUrl, i) => (
      <motion.div
        key={`key-${imgUrl}-${i}`}
        className="absolute flex flex-col items-center justify-center h-full origin-center rounded-xl bg-mauve-dark-2 p-2"
        style={{
          width: `${faceWidth}px`,
          transform: `rotateY(${i * (360 / faceCount)}deg) translateZ(${radius}px)`,
        }}
